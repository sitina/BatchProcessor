...
public class PropertiesConfiguration implements Configuration {
	...
	private ModuleConfiguration loadModuleConfiguration(int moduleIndex) {
		...
		Hashtable<String, String> moduleProperties = loadModuleProperties(modulePropertiesString);
	...
	private Hashtable<String, String> loadModuleProperties(String propertiesString) {
